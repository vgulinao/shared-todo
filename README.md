...
| S6  | Reorder via drag & drop                                        | [S6](specs/stories/S6-reorder.md)      | `shared/order.test.ts`, `client/src/lib/dnd.test.ts`, `server/app.test.ts`, `server/collaboration.test.ts`    |
| S7  | Sub-tasks with progress                                        | [S7](specs/stories/S7-subtasks.md)     | `shared/subtasks.test.ts`, `client/src/lib/dnd.test.ts`, `server/app.test.ts`, `server/collaboration.test.ts` |
